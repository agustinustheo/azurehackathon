"""
Django settings for JudgeYou project.
...
SECRET_KEY = '#m_gzm9(y(mpj1u*g)^c3h$67ui+pb6j!w4=+73$nno^8alowm'
...
WSGI_APPLICATION = 'JudgeYou.wsgi.application'
